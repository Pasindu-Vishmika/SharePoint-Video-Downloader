...
try:
    icon_path = resource_path('dependencies\\images\\mainicon.ico')
...
def open_contact_us():
    ...
    contact_icon1 = PhotoImage(file=resource_path('dependencies\\images\\dev1.png'))
    contact_icon2 = PhotoImage(file=resource_path('dependencies\\images\\dev2.png'))
    contact_icon3 = PhotoImage(file=resource_path('dependencies\\images\\dev3.png'))
    github_icon   = PhotoImage(file=resource_path('dependencies\\images\\github.png')) # Add your GitHub icon image path
